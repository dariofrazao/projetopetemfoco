...
public class AcessarEstabelecimentoFavoritoActivityTest {
    ...
    private static String sNome = "Luiz 4";
    ...
    //Teste que simula a ação de acessar um estabelecimento pela guia dos meus favoritos
    @Test
    public void testeAcessarEstabelecimentoTelaFavoritos() throws UiObjectNotFoundException, InterruptedException {
        TestTools.clicarEmITemListView(R.id.lv_meus_favoritos, 0);
        Thread.sleep(2000);
