...
public class RemoverFavoritoTelaEstabelecimentoActivityTest {
    ...
    private static String sNome = "Luiz";
    ...
    public void setUp() throws Exception {
        ...
        Thread.sleep(4000);
        TestToolsBuscaEstabelecimento.digitarBuscar(this.sNome);
        Thread.sleep(4000);
    ...
    //Teste que simula a ação de remover o um estabelecimento favorito na tela de informações do estabelecimento
    @Test
