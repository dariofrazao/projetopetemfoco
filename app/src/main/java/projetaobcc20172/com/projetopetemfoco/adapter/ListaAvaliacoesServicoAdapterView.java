...
public class ListaAvaliacoesServicoAdapterView extends ArrayAdapter<Avaliacao> {
    private ArrayList<Avaliacao> mAvaliacoes;
    private Context mContext;


    public ListaAvaliacoesServicoAdapterView(@NonNull Context context, ArrayList<Avaliacao> resultados) {
